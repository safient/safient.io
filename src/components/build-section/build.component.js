...
const BuildSection = () => {
  return (
    <BuildContainer>
      <h2>
        Build on <Span>Safient Protocol</Span>
      </h2>
      <p className='sub-heading'>
        Safient protcol is a a composable protocol that can be integrated with any services or can be used to build your
        own service. If you are looking to get started and know more about Safient Protcol, you can checkout our{' '}
