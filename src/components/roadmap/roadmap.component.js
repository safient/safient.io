  ...
  return (
    <TimeFrameContainer>
      <TimeFrame
        ...
        <li>
          We built a confidential portfolio sharing application (Portex) at
          ETHDenver 2021 to validate the technical feasibility. Portex gained a
          lot of traction for the implementation and was recognized as one of
          the top 20 hacks 🎊 .
        </li>
      </TimeFrame>
      ...
      <TimeFrame year="2021 APRIL" heading="Safient design and prototype ✨">
        <li>
          Taking all the feedback from our hackathon project, we started to
          design and prototype the solution for Safient. We planned all the
          features, integrations and laid out our architecture for the initial
          implementation, and conducted a detailed user research survey to
          verify our solution approach.
        </li>
      ...
      <TimeFrame year="2021 Q4" heading="Demo and Private beta release 🧪">
        ...
        <li>
          Initial community edition application for safekeeping and inheritance
          with a few safe claim approach.
        </li>
        <li>
          {" "}
      ...
      <TimeFrame year="2022 Q1" heading="Beta release to the community 🚀">
        ...
        <li>
          {" "}
          Planned economics to generate the right traction (value) for the users
          and incentivized actors
        </li>
      </TimeFrame>
      ...
      <TimeFrame year="2022 Q2" heading="Audit and mainnet release 🚀">
        ...
        <li>
          {" "}
          Safient will undergo bug bounty program and security audit before the
          mainnet release
        </li>
      </TimeFrame>
    </TimeFrameContainer>
